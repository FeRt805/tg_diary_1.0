...
def generate():
    ...
    for timetables_id, timetable_list in enumerate(timetables):
        ...
        timetable = timetable_list[1]
        timetables_id += 1
        # marks_num = random.randint(20, 35)  # Количество оценок
        # marks_num = random.randint(20, len(timetable.items()))  # Количество оценок
        # for _ in range(marks_num):
        #     day = random.choice(ddays)
        #     day_real = day[:day.find(" ")]
        #     if day_real != "Воскресенье" and day_real != "Суббота":
        ...
        # for _ in range(len(timetable.items())):
        #     # day = random.choice(ddays)
        #
        #     day_real = day[:day.find(" ")]
        #     if day_real != "Воскресенье" and day_real != "Суббота" and len(timetable[day_real]) > 3:
...
#     #
#     # if log:
#     #     print("Успешная обновление Оценок")
#     #     print("##########################")
